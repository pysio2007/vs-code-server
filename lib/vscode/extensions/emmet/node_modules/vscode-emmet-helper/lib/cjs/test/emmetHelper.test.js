...
mocha_1.describe('Test variables settings', () => {
    ...
    mocha_1.it('should use variables from the extensionsPath', () => {
        updateExtensionsPath(extensionsPath).then(() => {
            ...
            if (!expandOptions.variables || expandOptions.variables['lang'] !== 'fr') {
                assert_1.default.ok(false, 'Most likely a Mocha error. Please run tests again.');
            }
...
mocha_1.describe('Test custom snippets', () => {
    ...
    mocha_1.it('should reset custom snippets when no extensionsPath is given', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return updateExtensionsPath(null).then(() => {
            ...
            assert_1.default.ok(!e, 'When extensionsPath is not given, there should not be any error.');
        });
    }));
});
