...
describe('Test output profile settings', () => {
    ...
    it('should use profile from settings that overrides the ones from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
...
describe('Test custom snippets', () => {
    it('should use custom snippets for given syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should use custom snippets inherited from base syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(null);
    ...
    it('should use custom snippets for given syntax in the absence of base syntax from extensionsPath', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(null);
        const expandOptionsWithoutCustomSnippets = getExpandOptions('scss');
        assert(!expandOptionsWithoutCustomSnippets.snippets);
    ...
    it('should reset custom snippets when no extensionsPath is given', () => __awaiter(void 0, void 0, void 0, function* () {
        const customSnippetKey = 'ch';
        yield updateExtensionsPath(extensionsPath);
...
describe('Test filters (bem and comment)', () => {
    it('should expand haml', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        assert.strictEqual(expandAbbreviation('ul[data="class"]', getExpandOptions('haml', {})), '%ul(data="class") ${0}');
    }));
    it('should expand attributes with []', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        assert.strictEqual(expandAbbreviation('div[[a]="b"]', getExpandOptions('html', {})), '<div [a]="b">${0}</div>');
    }));
    it('should expand abbreviations that are nodes with no name', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        assert.strictEqual(expandAbbreviation('c', getExpandOptions('html', {})), '<!-- ${0} -->');
    }));
    it('should use filters from expandOptions', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should use filters from syntaxProfiles', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
...
describe('Test completions', () => {
    it('should provide multiple common tags completions in html', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide multiple snippet suggestions in html', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should not provide any suggestions in html for class names or id', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide multiple snippet suggestions in html for nested abbreviations', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide completions html', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide completions css', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['trf', 'transform: ;'],
    ...
    it('should not provide html completions for xml', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should provide hex color completions css', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['#1', '#111'],
            ['#ab', '#ababab'],
    ...
    it.skip('should provide empty incomplete completion list for abbreviations that just have the vendor prefix', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['-', 0, 1],
            ['-m-', 0, 3],
    ...
    it('should provide completions for text that are prefix for snippets, ensure $ doesnt get escaped', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['<div> l </div>', 0, 7]
        ];
    ...
    it('should provide completions with escaped $ in scss', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['bgi$hello', 0, 9]
        ];
    ...
    it('should provide completions with escaped $ in html', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
    ...
    it('should provide completions using custom snippets html', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const testCases = [
    ...
    it('should provide completions using custom snippets css and unit aliases', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const testCases = [
    ...
    it('should provide both custom and default snippet completion when partial match with custom snippet', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const expandOptions = {
            preferences: {},
            showExpandedAbbreviation: 'always',
    ...
    it('should not provide completions as they would noise when typing (html)', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['<div>abc</div>', 0, 8],
            ['<div>Abc</div>', 0, 8],
    ...
    it('should not provide completions as they would noise when typing (css)', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const testCases = [
            ['background', 0, 10],
            ['font-family', 0, 11],
    ...
    it('should provide completions for loremn with n words', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide completions for lorem*n with n lines', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it.skip('should provide completions using vendor prefixes', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const testCases = [
    ...
    it.skip('should provide completions using vendor prefixes with custom preferences', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(extensionsPath);
        const testCases = [
            ['brs', 0, 3, 'border-radius: ;', 'border-radius: |;', 'brs'],
            ['brs5', 0, 4, 'border-radius: 5px;', 'border-radius: 5px;', 'brs5'],
    ...
    it.skip('should expand with multiple vendor prefixes', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it.skip('should expand with default vendor prefixes in properties', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should not provide completions for excludedLanguages', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
    ...
    it('should provide completions with kind snippet when showSuggestionsAsSnippets is enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
        const document = TextDocument.create('test://test/test.html', 'html', 0, 'ul>li');
        const position = Position.create(0, 5);
        const completionList = doComplete(document, position, 'html', {
    ...
    it('should not provide double completions for commonly used tags that are also snippets', () => __awaiter(void 0, void 0, void 0, function* () {
        yield updateExtensionsPath(null);
