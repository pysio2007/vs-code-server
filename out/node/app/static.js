...
exports.StaticHttpProvider = void 0;
...
var StaticHttpProvider = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getReplacedResource(request, route)];
                    case 1:
                        response = _a.sent();
                        if (!this.isDev) {
                            response.cache = true;
     ...
     */
    StaticHttpProvider.prototype.getReplacedResource = function (request, route) {
        return __awaiter(this, void 0, void 0, function () {
            var split, resourcePath, validPaths, _a, response;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        split = route.requestPath.split("/").slice(1);
                        resourcePath = path.resolve.apply(path, __spreadArrays(["/"], split));
                        validPaths = [this.rootPath, process.env.PLUGIN_DIR];
                        if (!validPaths.find(function (p) { return p && resourcePath.startsWith(p); })) {
                            this.ensureAuthenticated(request);
                        }
                        ...
                        return [3 /*break*/, 3];
                    case 1: return [4 /*yield*/, this.getUtf8Resource(resourcePath)];
                    case 2:
                        response = _b.sent();
                        return [2 /*return*/, this.replaceTemplates(route, response)];
                    case 3: return [2 /*return*/, this.getResource(resourcePath)];
                }
            });
        });
    };
