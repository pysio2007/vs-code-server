...
var HttpServer = /** @class */ (function () {
        ...
        this.onRequest = function (request, response) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 5, , 9]);
                        return [4 /*yield*/, this.handleRequest(route, request)];
                    case 2:
                        _a = (_d.sent());
                    ...
                    case 5:
                        ...
                        if (!(request.headers["content-type"] === "application/json")) return [3 /*break*/, 6];
                        write({
                            code: code,
        ...
        this.onUpgrade = function (request, socket, head) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        socketProxy = _b.sent();
                        _a = this.maybeProxy(route, request);
    ...
    HttpServer.prototype.listen = function () {
        ...
        if (!this.listenPromise) {
            this.listenPromise = new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var onListen, err_1;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            onListen = function () { return resolve(_this.address()); };
                            if (!this.options.socket) return [3 /*break*/, 5];
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, fs.unlink(this.options.socket)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
                            ...
                            if (err_1.code !== "ENOENT") {
                                logger_1.logger.warn(err_1.message);
                            }
                            return [3 /*break*/, 4];
                        case 4:
     ...
     */
    HttpServer.prototype.handleRequest = function (route, request) {
        return __awaiter(this, void 0, void 0, function () {
            var filePath;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (this.options.cert && !request.connection.encrypted) {
                            return [2 /*return*/, { redirect: route.fullPath }];
                        }
                        if (!(route.fullPath === "/robots.txt")) return [3 /*break*/, 2];
                        filePath = path.resolve(__dirname, "../../src/browser/robots.txt");
                        _a = {};
                        return [4 /*yield*/, fs.readFile(filePath)];
                    case 1: return [2 /*return*/, (_a.content = _b.sent(), _a.filePath = filePath, _a)];
                    case 2: 
                    // Handle proxy domains.
                    return [2 /*return*/, this.maybeProxy(route, request)];
                }
            });
        });
    };
     ...
     */
    HttpServer.prototype.maybeProxy = function (route, request) {
        // Split into parts.
