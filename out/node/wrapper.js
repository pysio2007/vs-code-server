...
exports.WrapperProcess = exports.ipcMain = exports.IpcMain = exports.ProcessError = void 0;
...
var IpcMain = /** @class */ (function () {
     ...
     */
    IpcMain.prototype.preventExit = function () {
        process.exit = function (code) {
            logger_1.logger.warn("process.exit() was prevented: " + (code || "unknown code") + ".");
        };
    };
    Object.defineProperty(IpcMain.prototype, "isChild", {
        get: function () {
 ...
 */
exports.ipcMain = new IpcMain(typeof process.env.CODE_SERVER_PARENT_PID !== "undefined" ? parseInt(process.env.CODE_SERVER_PARENT_PID) : undefined);
/**
...
var WrapperProcess = /** @class */ (function () {
    ...
    WrapperProcess.prototype.disposeChild = function () {
    ...
    WrapperProcess.prototype._start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var child;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, exports.ipcMain.handshake(child)];
                    case 1:
                        _a.sent();
                        child.once("exit", function (code) {
    ...
    WrapperProcess.prototype.spawn = function () {
        ...
        var nodeOptions = (process.env.NODE_OPTIONS || "") + " " + ((this.options && this.options.nodeOptions) || "");
