...
exports.VscodeHttpProvider = void 0;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        if (!this.isRoot(route)) {
                            ...
                            return [2 /*return*/, { redirect: "/login", query: { to: route.providerBase } }];
                        }
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                ...
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        settings_1.settings.write({
                            lastVisited: startPath || lastVisited,
                            query: route.query,
                        });
                        if (!this.isDev) {
